  ...
  for (int k=0; k<3; k++)
    {
      ...
      fBg2[k]->SetParameter(0, 307856);
      fBg2[k]->SetParLimits(0, 0, 350000);

      fBg2[k]->SetParameter(1, 0.755);
      fBg2[k]->SetParameter(2, 0.0953);
      fBg2[k]->SetParLimits(2, 0.0953, 0.126);

      fBg2[k]->SetParameter(4, 0.968);
      fBg2[k]->SetParameter(5, 0.107);
	...
	CloneHist2->SetBinError(b,hUSSBg[k]->GetBinError(b));
      ...
      if(k==0){
	fFit[k]->FixParameter(0, fBg2[k]->GetParameter(0));
	...
	fFit[k]->SetParameter(0, fFit[k-1]->GetParameter(0));
	fFit[k]->FixParameter(1, fFit[k-1]->GetParameter(1));
	fFit[k]->FixParameter(2, fFit[k-1]->GetParameter(2));
	
	fFit[k]->SetParameter(3, fFit[k-1]->GetParameter(3));
	fFit[k]->FixParameter(4, fFit[k-1]->GetParameter(4));
	fFit[k]->FixParameter(5, fFit[k-1]->GetParameter(5));
      }
      
      fFit[k]->SetParLimits(6, 0, fBg2[k]->GetParameter(6));
      ...
      /* else{ */
      /* 	fFit[k]->SetParameter(0, fBg2[k-1]->GetParameter(0)); */
      /* 	fFit[k]->SetParameter(1, fBg2[k-1]->GetParameter(1)); */
      /* 	fFit[k]->SetParameter(2, fBg2[k-1]->GetParameter(2)); */
	
      /* 	fFit[k]->SetParameter(3, fBg2[k-1]->GetParameter(3)); */
      /* 	fFit[k]->SetParameter(4, fBg2[k-1]->GetParameter(4)); */
      /* 	fFit[k]->SetParameter(5, fBg2[k-1]->GetParameter(5)); */
	
      /* 	fFit[k]->SetParameter(6, fBg2[k-1]->GetParameter(6)); */
      /* 	fFit[k]->SetParameter(7, fBg2[k-1]->GetParameter(7)); */
      /* 	fFit[k]->SetParameter(8, fBg2[k-1]->GetParameter(8)); */
      ...
      TF1* pol2bg = new TF1("pol2bg", "pol2(0)", BgMinRange, BgMaxRange);
