  ...
  for (int k=0; k<nPtBins; k++)
    {
      ...
      fBg2[k] = new TF1(Form("kstar_GausBg_%i",k), "gaus(0)+[3]*BreitWignerRelativistic(x, [4], [5]) + pol3(6)", BgMinRange, BgMaxRange);
      fFit[k] = new TF1(Form("kstar_fullFit_%i",k), "gaus(0)+[3]*BreitWignerRelativistic(x, [4], [5]) + pol3(6) + [10]*BreitWignerRelativistic(x, [11], [12])", BgMinRange, BgMaxRange);
      ...
      //=================================================================
      fFit[k]->SetParLimits(0, 0, 40000);
      fFit[k]->SetParLimits(1, 0.695, 0.780);
      fFit[k]->SetParLimits(2, 0.0463, 0.126);

      fFit[k]->SetParLimits(3, 0, 70000);
      fFit[k]->SetParLimits(4, 0.890, 1.010);
      fFit[k]->SetParLimits(5, 0.078, 0.287);
      ...
      fFit[k]->SetParameter(9, fBg2[k]->GetParameter(9));
      
      fFit[k]->SetParameter(10, fkstar[k]->GetParameter(0)); //DO NOT FIX      
      fFit[k]->FixParameter(11, fkstar[k]->GetParameter(1));
      fFit[k]->FixParameter(12, fkstar[k]->GetParameter(2));
      ...
      totbg[k] = new TF1(Form("totbg_%i",k), "gaus(0) + [3]*BreitWignerRelativistic(x, [4], [5]) + pol3(6)", BgMinRange, BgMaxRange);
      ...
      totbg[k]->FixParameter(0, fFit[k]->GetParameter(0));
      totbg[k]->FixParameter(1, fFit[k]->GetParameter(1));
      totbg[k]->FixParameter(2, fFit[k]->GetParameter(2));
      totbg[k]->FixParameter(3, fFit[k]->GetParameter(3));
      totbg[k]->FixParameter(4, fFit[k]->GetParameter(4));
      totbg[k]->FixParameter(5, fFit[k]->GetParameter(5));
      totbg[k]->FixParameter(6, fFit[k]->GetParameter(6));
      totbg[k]->FixParameter(7, fFit[k]->GetParameter(7));
      totbg[k]->FixParameter(8, fFit[k]->GetParameter(8));
      totbg[k]->FixParameter(9, fFit[k]->GetParameter(9));
      ...
      legendd->AddEntry(gausbg[k], "gaus", "l");
      legendd->AddEntry(f0bg[k], "f0bw", "l");
      legendd->AddEntry(pol3bg[k], "pol3", "l");
      legendd->Draw("SAME");
