  ...
  for (int k=0; k<nPtBins; k++)
    {
      ...
      // Function
      // ==============
      fkstar[k] = new TF1(Form("kstar_%i",k), "[0]*BreitWignerRelativistic(x, [1], [2])", 0.86, 0.94);
      ...
      fFit[k]->SetParLimits(3, 0, 10000);
      fFit[k]->SetParLimits(4, 0.938, 1.010);
      fFit[k]->SetParLimits(5, 0.078, 0.187);
