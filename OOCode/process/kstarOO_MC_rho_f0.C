...
void DrawBW()
{
  ...
  for (int k=0; k<1; k++)
	...
	CloneHist->SetBinError(b,hUSSBg[k]->GetBinError(b));
      ...
      fBg2[k]->SetParameter(1, 0.770);
      fBg2[k]->SetParameter(2, 0.062);
      
      fBg2[k]->SetParameter(4, 0.970);
      fBg2[k]->SetParameter(5, 0.6);
	...
	CloneHist2->SetBinError(b,hUSSBg[k]->GetBinError(b));
      ...
      fFit[k]->SetParameter(6, fkstar[k]->GetParameter(0)); //DO NOT FIX      
      fFit[k]->FixParameter(7, fkstar[k]->GetParameter(1));
      fFit[k]->FixParameter(8, fkstar[k]->GetParameter(2));
      ...
      bw->FixParameter(0, fFit[k]->GetParameter(6));
      bw->FixParameter(1, fFit[k]->GetParameter(7));
      bw->FixParameter(2, fFit[k]->GetParameter(8));
