...
void DrawBW()
{
  ...
  // Data file inputs 
  TString mainfile = "../kstar-in-oo/Result_rootfile/apass2_DATA_small.root";
  ...
  for (Int_t i=0; i<nPtBins; i++)
      ...
      for (Int_t j=0; j<nCentBins; j++)
	{
	  ...
	  (hUSS_KPi_MC->GetAxis(0))->SetRangeUser(20, 40);
	  (hUSS_PiK_MC->GetAxis(0))->SetRangeUser(20, 40);
	  ...
	  (hLSS_KPi_MC->GetAxis(0))->SetRangeUser(20, 40);
	  (hLSS_PiK_MC->GetAxis(0))->SetRangeUser(20, 40);
