...
void DrawBW(TString Kind, TString USS, TString LSS)
{
  ...
  // Jet
	...
	if (k==8){
	  ...
	  for (int bin = hUSS_Y_Bg[k]->FindBin(0.76); bin <= hUSS_Y_Bg[k]->FindBin(0.99); bin++)
	    hUSS_Y_Bg[k]->SetBinError(bin, 0);
	  for (int bin = hUSS_Y_ExtraBg[k]->FindBin(0.81); bin <= hUSS_Y_ExtraBg[k]->FindBin(0.94); bin++)
	    hUSS_Y_ExtraBg[k]->SetBinError(bin, 0);
	  for (int bin = hUSS_Y_kstarSig[k]->FindBin(0.77); bin <= hUSS_Y_kstarSig[k]->FindBin(0.81); bin++)
	    hUSS_Y_kstarSig[k]->SetBinError(bin, 0);
	  ...
	  for (int bin = hUSS_Y_Bg[k]->FindBin(0.76); bin <= hUSS_Y_Bg[k]->FindBin(0.98); bin++)
	    hUSS_Y_Bg[k]->SetBinError(bin, 0);
	  for (int bin = hUSS_Y_ExtraBg[k]->FindBin(0.80); bin <= hUSS_Y_ExtraBg[k]->FindBin(0.98); bin++)
	    hUSS_Y_ExtraBg[k]->SetBinError(bin, 0);
	  for (int bin = hUSS_Y_kstarSig[k]->FindBin(0.77); bin <= hUSS_Y_kstarSig[k]->FindBin(0.81); bin++)
	    hUSS_Y_kstarSig[k]->SetBinError(bin, 0);
	  ...
	  fFit[k]->SetParameter(0, fBg_POST[4]->GetParameter(0));
	  fFit[k]->SetParameter(1, fBg_POST[4]->GetParameter(1));
	  fFit[k]->SetParameter(2, fBg_POST[4]->GetParameter(2));
	  fFit[k]->SetParameter(3, fBg_POST[4]->GetParameter(3));
	  fFit[k]->SetParameter(4, fBg_POST[4]->GetParameter(4));
	  fFit[k]->SetParameter(5, fBg_POST[4]->GetParameter(5));
	  fFit[k]->SetParameter(6, fBg_POST[4]->GetParameter(6));
	  fFit[k]->SetParameter(7, fBg_POST[4]->GetParameter(7));
	  fFit[k]->SetParameter(8, fBg_POST[4]->GetParameter(8));
	  fFit[k]->SetParameter(9, fkstar_POST[4]->GetParameter(0));
	  fFit[k]->SetParameter(10, fkstar_POST[4]->GetParameter(1));
	  fFit[k]->SetParameter(11, fkstar_POST[4]->GetParameter(2));
	}
