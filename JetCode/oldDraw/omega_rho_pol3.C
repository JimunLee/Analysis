  ...
  for (int k=1; k<nPtBins+1; k++)
    {
      ...
      // fitting kstar
      // kstar
      fBW_kstar[nPtBins-k] = new TF1(Form("kstar_bw_%i",nPtBins-k), "[0]*TMath::BreitWigner(x, [1], [2])", kstarMinRange, kstarMaxRange);
      ...
      fFit[nPtBins-k]->SetParameter(9, fBg[nPtBins-k]->GetParameter(0)); 
      fFit[nPtBins-k]->SetParameter(10, fBg[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(11, fBg[nPtBins-k]->GetParameter(2));
      fFit[nPtBins-k]->SetParameter(12, fBg[nPtBins-k]->GetParameter(3));
      ...
      fBg[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(9));
      fBg[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(10));
      fBg[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(11));
      fBg[nPtBins-k]->SetParameter(3, fFit[nPtBins-k]->GetParameter(12));
