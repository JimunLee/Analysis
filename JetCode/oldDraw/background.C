...
void DrawBW(TString Kind, TString USS, TString LSS)
{
  ...
  for (int k=1; k<nPtBins+1; k++)
	...
	hUSS_Y_Bkg[nPtBins-k]->SetBinError(bin,0);
      ...
      // omega
      fBW_omega[nPtBins-k] = new TF1(Form("omega_bw_%i", nPtBins-k), "[3]*BreitWignerRelativistic(x, [4], [5])", omegaMinRange, omegaMaxRange);

      fBW_omega[nPtBins-k]->SetParLimits(3, Min, Max);
      fBW_omega[nPtBins-k]->SetParLimits(4, omegaMassMin, omegaMassMax);
      fBW_omega[nPtBins-k]->FixParameter(5, 0.00849);

      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_omega[nPtBins-k], "0", "", omegaMassMin, omegaMassMax);

      // rho
      fBW_rho[nPtBins-k] = new TF1(Form("rho_bw_%i", nPtBins-k), "[6]*BreitWignerRelativistic(x, [7], [8])", rhoMinRange, rhoMaxRange);

      fBW_rho[nPtBins-k]->SetParLimits(6, Min, Max);
      fBW_rho[nPtBins-k]->SetParLimits(7, rhoMassMin, rhoMassMax);
      fBW_rho[nPtBins-k]->FixParameter(8, 0.1478);

      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_rho[nPtBins-k], "0", "", rhoMassMin, rhoMassMax);

      // background
      fBg[nPtBins-k] = new TF1(Form("BgFit_%i", nPtBins-k), "pol3(9)", Bglow, Bghigh);
      fBg[nPtBins-k]->GetParameter(9);
      fBg[nPtBins-k]->GetParameter(10);
      fBg[nPtBins-k]->GetParameter(11);
      fBg[nPtBins-k]->GetParameter(12);
      ...
      // ===============
      // fitting entire
      fFit[nPtBins-k] = new TF1(Form("Fullfit_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2]) + [3]*BreitWignerRelativistic(x, [4], [5]) + [6]*BreitWignerRelativistic(x, [7], [8]) + pol3(9)", Bglow, Bghigh);
      ...
      fFit[nPtBins-k]->SetParameter(3, fBW_omega[nPtBins-k]->GetParameter(3));
      fFit[nPtBins-k]->SetParameter(4, fBW_omega[nPtBins-k]->GetParameter(4));
      fFit[nPtBins-k]->SetParameter(5, fBW_omega[nPtBins-k]->GetParameter(5));

      fFit[nPtBins-k]->SetParameter(6, fBW_rho[nPtBins-k]->GetParameter(6));
      fFit[nPtBins-k]->SetParameter(7, fBW_rho[nPtBins-k]->GetParameter(7));
      fFit[nPtBins-k]->SetParameter(8, fBW_rho[nPtBins-k]->GetParameter(8));
     
      /* fFit[nPtBins-k]->SetParLimits(9, fBg[nPtBins-k]->GetParameter(9)*0.9, fBg[nPtBins-k]->GetParameter(9)*1.1); */
      /* fFit[nPtBins-k]->SetParLimits(10, fBg[nPtBins-k]->GetParameter(10)*0.9, fBg[nPtBins-k]->GetParameter(10)*1.1); */
      /* fFit[nPtBins-k]->SetParLimits(11, fBg[nPtBins-k]->GetParameter(11)*0.9, fBg[nPtBins-k]->GetParameter(11)*1.1); */
      /* fFit[nPtBins-k]->SetParLimits(12, fBg[nPtBins-k]->GetParameter(12)*0.9, fBg[nPtBins-k]->GetParameter(12)*1.1); */

      fFit[nPtBins-k]->SetParameter(9, fBg[nPtBins-k]->GetParameter(9));
      fFit[nPtBins-k]->SetParameter(10, fBg[nPtBins-k]->GetParameter(10));
      fFit[nPtBins-k]->SetParameter(11, fBg[nPtBins-k]->GetParameter(11));
      fFit[nPtBins-k]->SetParameter(12, fBg[nPtBins-k]->GetParameter(12));
      ...
      fBW_omega[nPtBins-k]->SetParLimits(3, 0, fFit[nPtBins-k]->GetParameter(3));
      fBW_omega[nPtBins-k]->SetParameter(4, fFit[nPtBins-k]->GetParameter(4));
      fBW_omega[nPtBins-k]->SetParameter(5, fFit[nPtBins-k]->GetParameter(5));

      fBW_rho[nPtBins-k]->SetParameter(6, fFit[nPtBins-k]->GetParameter(6));
      fBW_rho[nPtBins-k]->SetParameter(7, fFit[nPtBins-k]->GetParameter(7));
      fBW_rho[nPtBins-k]->SetParameter(8, fFit[nPtBins-k]->GetParameter(8));

      fBg[nPtBins-k]->SetParameter(9, fFit[nPtBins-k]->GetParameter(9));
      fBg[nPtBins-k]->SetParameter(10, fFit[nPtBins-k]->GetParameter(10));
      fBg[nPtBins-k]->SetParameter(11, fFit[nPtBins-k]->GetParameter(11));
      fBg[nPtBins-k]->SetParameter(12, fFit[nPtBins-k]->GetParameter(12));
      ...
      hUSS_Y_Fit[nPtBins-k]->Draw("SAME");
