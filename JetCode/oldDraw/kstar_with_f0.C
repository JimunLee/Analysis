...
void DrawBW(TString Kind, TString USS, TString LSS)
{
  ...
  for (int k=1; k<nPtBins+1; k++)
      ...
      else
	{
      ...
      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_omega[nPtBins-k], "0", "", omegaMinRange, omegaMaxRange);
      ...
      fBW_rho[nPtBins-k]->FixParameter(1, rhoMass);
      fBW_rho[nPtBins-k]->FixParameter(2, 0.1478);

      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_rho[nPtBins-k], "0", "", rhoMinRange, rhoMaxRange);

      //f0
      fBW_f0[nPtBins-k] = new TF1(Form("f0_bw_%i", nPtBins-k), "[0]*BreitWignerRelativistic(x, [1], [2])", f0MinRange, f0MaxRange);

      fBW_f0[nPtBins-k]->SetParLimits(0, Min, Max);
      fBW_f0[nPtBins-k]->FixParameter(1, f0Mass);
      fBW_f0[nPtBins-k]->FixParameter(2, 0.061);

      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_f0[nPtBins-k], "0", "", f0MinRange, f0MaxRange);
      ...
      // ===============
      // fitting entire 
      fFit[nPtBins-k] = new TF1(Form("Fullfit_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2]) + pol3(6) + [3]*BreitWignerRelativistic(x, [4], [5]) +[10]*BreitWignerRelativistic(x, [11], [12]) + [13]*BreitWignerRelativistic(x, [14], [15])", Bglow, Bghigh);
 
      fFit[nPtBins-k]->SetParLimits(0, 0, fBW_kstar[nPtBins-k]->GetParameter(0));
      ...
      fFit[nPtBins-k]->SetParLimits(3, 0, fBW_rho[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->SetParameter(4, fBW_rho[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(5, fBW_rho[nPtBins-k]->GetParameter(2));
      ...
      fFit[nPtBins-k]->SetParLimits(13, 0, fBW_f0[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->SetParameter(14, fBW_f0[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(15, fBW_f0[nPtBins-k]->GetParameter(2));
      ...
      fBW_rho[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(3));
      fBW_rho[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(4));
      fBW_rho[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(5));
      ...
      fBW_f0[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(13));
      fBW_f0[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(14));
      fBW_f0[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(15));
      ...
      fBW_f0[nPtBins-k]->SetLineColor(11); 
      fBW_f0[nPtBins-k]->Draw("SAME");
