  ...
  for (int k=1; k<nPtBins+1; k++)
    {
      ...
      //kstar800
      fBW_k800[nPtBins-k] = new TF1(Form("kstar800_bw_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2])", k800MinRange, k800MaxRange);

      fBW_k800[nPtBins-k]->SetParLimits(0, Min, Max);
      fBW_k800[nPtBins-k]->SetParLimits(1, k800MassMin, k800MassMax);
      ...
      // ===============
      // fitting entire 
      fFit[nPtBins-k] = new TF1(Form("Fullfit_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2]) + [3]*BreitWignerRelativistic(x, [4], [5]) + [6]*BreitWignerRelativistic(x, [7], [8]) + [9]*BreitWigner(x, [10], [11])", Bglow, Bghigh);
      ...
      fFit[nPtBins-k]->SetParameter(9, fBW_k800[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->SetParameter(10, fBW_k800[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(11, fBW_k800[nPtBins-k]->GetParameter(2));
      ...
      fBW_omega[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(3));
      ...
      fBW_k800[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(9));
      fBW_k800[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(10));
      fBW_k800[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(11));
