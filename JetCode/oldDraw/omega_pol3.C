  ...
  for (int k=1; k<nPtBins+1; k++)
    {
      ...
      /* // add */
      /* for(int bin = hUSS_Y_Fit[nPtBins-k]->FindBin(0.75); bin<=hUSS_Y_Fit[nPtBins-k]->FindBin(0.827); bin++) */
      ...
      fBW_omega[nPtBins-k]->SetParLimits(0, Min, 0.000001);
      ...
      fBg[nPtBins-k]->SetParLimits(0, 0.000001, 0.001);
      fBg[nPtBins-k]->SetParLimits(1, -1, 1);
      ...
      // ===============
      // fitting entire
      fFit[nPtBins-k] = new TF1(Form("Fullfit_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2]) + [3]*BreitWignerRelativistic(x, [4], [5]) + pol3(6)", Bglow, Bghigh);
      ...
      fcomplete_kstar[nPtBins-k] = new TF1(Form("kstar_bw_%i",nPtBins-k), "[0]*BreitWigner(x, [1], [2])", kstarMinRange, kstarMaxRange);
      fcomplete_omega[nPtBins-k] = new TF1(Form("omega_bw_%i", nPtBins-k), "[0]*BreitWignerRelativistic(x, [1], [2])", omegaMinRange, omegaMaxRange);
      fcomplete_Bg[nPtBins-k] = new TF1(Form("BgFit_%i", nPtBins-k), "pol3(0)", Bglow, Bghigh);
      
      fcomplete_kstar[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(0));
      fcomplete_kstar[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(1));
      fcomplete_kstar[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(2));

      fcomplete_omega[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(3));
      fcomplete_omega[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(4));
      fcomplete_omega[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(5));
            
      fcomplete_Bg[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(6));
      fcomplete_Bg[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(7));
      fcomplete_Bg[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(8));
      fcomplete_Bg[nPtBins-k]->SetParameter(3, fFit[nPtBins-k]->GetParameter(9));
      ...
      fcomplete_kstar[nPtBins-k]->SetLineColor(6);
      fcomplete_kstar[nPtBins-k]->Draw("SAME");
      
      fcomplete_Bg[nPtBins-k]->SetLineColor(4);
      fcomplete_Bg[nPtBins-k]->SetLineStyle(2);
      fcomplete_Bg[nPtBins-k]->Draw("SAME");
      
      fcomplete_omega[nPtBins-k]->SetLineColor(8);
      fcomplete_omega[nPtBins-k]->Draw("SAME");
