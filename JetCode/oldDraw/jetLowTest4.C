...
// Draw function
void Shreck();
TLatex* DrawTLatexShreck(double x, double y, const TString& text, double textSize, int textFont, int textColor) {
...
void DrawBW(TString Kind, TString USS, TString LSS)
{
  ...
  double ExtraMaxRange = 0.98;
  
  double kstarMinRange = 0.85;
  double kstarMaxRange = 0.95;
  
  double BgMinRange = 0.75;
