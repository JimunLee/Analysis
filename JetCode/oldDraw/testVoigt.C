...
void DrawVoigt(TString Kind, TString USS, TString LSS)
{
  ...
  //=========================================
  TString SignalName("kstar-in-jets/"+USS+";1");
  TString BackgroundName("kstar-in-jets/"+LSS+";1");
  TString Eventdata("kstar-in-jets/nEvents;1");
  ...
  TH1D* FJpt = (TH1D*)data->Get("kstar-in-jets/FJptHistogram;1");
  ...
  for(int fpt=0; fpt<nPtBins; fpt++) //nPtBins+1 MUST DELETE +! When i wanna draw one histogram
	...
	hUSS_Y_Bkg[fpt]->SetBinError(bin,0);
      ...
      //=================================================================================
      // Peak Function of voigt                 | BreitWigner                           |
      //=================================================================================
      //| Information : K*                      | Information : K*                      |
      //| gamma(1,3) : 0.0508                   | gamma(1) : 0.0508                     |
      //| mass(2) : 0.89166                     | mass(2) : 0.89166                     |
      //=================================================================================
      fBreit[fpt] = new TF1(Form("BwFit_%i",fpt),"[0]*TMath::BreitWigner(x-[2], [1])", Siglow, Sighigh);
      ...
      fBreitCopy[fpt] = new TF1(Form("BwFit_Copy_%i",fpt),"[0]*TMath::BreitWigner(x-[2], [1])", Siglow, Sighigh);
      ...
      //=========================================
      fFit[fpt] = new TF1(Form("FullFit_%i",fpt), "[0]*TMath::BreitWigner(x-[2], [1]) + pol3(3)", Bglow, Bghigh);
      ...
      // BACKGROUND
      fFit[fpt]->SetParameter(3, fBg[fpt]->GetParameter(0));
      fFit[fpt]->SetParameter(4, fBg[fpt]->GetParameter(1));
      fFit[fpt]->SetParameter(5, fBg[fpt]->GetParameter(2));
      fFit[fpt]->SetParameter(6, fBg[fpt]->GetParameter(3));
      ...
      fBg[fpt]->SetParameter(0, fFit[fpt]->GetParameter(3));
      fBg[fpt]->SetParameter(1, fFit[fpt]->GetParameter(4));
      fBg[fpt]->SetParameter(2, fFit[fpt]->GetParameter(5));
      fBg[fpt]->SetParameter(3, fFit[fpt]->GetParameter(6));
