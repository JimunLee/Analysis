...
void DrawBW(TString Kind, TString USS, TString LSS)
{
  ...
  double k800MassMin = 0.67640-0.040;
  double k800MassMax = 0.67640+0.040;
  ...
  for (int k=1; k<nPtBins+1; k++)
    {
      ...
      fBW_rho[nPtBins-k]->SetParLimits(2, 0.1469, 0.1487);

      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_rho[nPtBins-k], "0", "", rhoMassMin, rhoMassMax);
      
      //kstar800
      fBW_k800[nPtBins-k] = new TF1(Form("kstar800_bw_%i", nPtBins-k), "[9]*BreitWigner(x, [10], [11])", k800MinRange, k800MaxRange);

      fBW_k800[nPtBins-k]->SetParLimits(9, Min, Max);
      fBW_k800[nPtBins-k]->SetParLimits(10, k800MassMin, k800MassMax);
      fBW_k800[nPtBins-k]->FixParameter(11, 0.548);
      
      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_k800[nPtBins-k], "0", "", k800MassMin, k800MassMax);

      // background
      //  hUSS_Y_Bkg[nPtBins-k]->Add(hUSS_Y_Fit[nPtBins-k]);
      
      fBg[nPtBins-k] = new TF1(Form("BgFit_%i", nPtBins-k), "pol3", Bglow, Bghigh);

      fBg[nPtBins-k]->SetParLimits(0, Min, Max);
      fBg[nPtBins-k]->SetParameter(1, 1);
      fBg[nPtBins-k]->SetParameter(2, 2);
      fBg[nPtBins-k]->SetParameter(3, 3);
      ...
      // ===============
      // fitting entire 
      fFit[nPtBins-k] = new TF1(Form("Fullfit_%i", nPtBins-k), "[4]*BreitWigner(x, [5], [6]) + [7]*BreitWignerRelativistic(x, [8], [9]) + [10]*BreitWignerRelativistic(x, [11], [12]) + pol3(0)", Bglow, Bghigh);
 
      fFit[nPtBins-k]->SetParameter(4, fBW_kstar[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->SetParameter(5, fBW_kstar[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(6, fBW_kstar[nPtBins-k]->GetParameter(2));

      fFit[nPtBins-k]->SetParameter(7, fBW_omega[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->SetParameter(8, fBW_omega[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(9, fBW_omega[nPtBins-k]->GetParameter(2));

      fFit[nPtBins-k]->SetParameter(10, fBW_rho[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->SetParameter(11, fBW_rho[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(12, fBW_rho[nPtBins-k]->GetParameter(2));
      ...
      fBW_kstar[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(4));
      fBW_kstar[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(5));
      fBW_kstar[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(6));

      fBW_omega[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(7));
      fBW_omega[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(8));
      fBW_omega[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(9));

      fBW_rho[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(10));
      fBW_rho[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(11));
      fBW_rho[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(12));

      fBg[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(0));
      fBg[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(1));
      fBg[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(2));
      fBg[nPtBins-k]->SetParameter(3, fFit[nPtBins-k]->GetParameter(3));
      ...
      fBW_k800[nPtBins-k]->SetLineColor(12);//a bit dark
      fBW_k800[nPtBins-k]->Draw("SAME");

      fBg[nPtBins-k]->SetLineColor(4);//blue
