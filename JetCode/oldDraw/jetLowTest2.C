  ...
  for (int k=1; k<nPtBins+1; k++)
    {
      ...
      for (int bin = hUSS_Y_Bg[nPtBins-k]->FindBin(0.85); bin <= hUSS_Y_Bg[nPtBins-k]->FindBin(0.94); bin++)
	...
	hUSS_Y_ExtraBg[nPtBins-k]->SetBinError(bin, 0);
      ...
      for (int bin = hUSS_Y_kstarSig[nPtBins-k]->FindBin(0.77); bin <= hUSS_Y_kstarSig[nPtBins-k]->FindBin(0.83); bin++)
