...
void DrawBW(TString Kind, TString USS, TString LSS)
{
  ...
  double kstarMassMin = 0.89581-0.02;
  double kstarMassMax = 0.89581+0.02;
  double kstarMass = 0.89581;
  double omegaMass = 0.77526;
  double rhoMass = 0.775;

  double omegaMassMin = 0.78265-0.02;
  double omegaMassMax = 0.78265+0.02;

  double rhoMassMin = 0.77526-0.02;
  double rhoMassMax = 0.77526+0.02;
  ...
  for (int k=1; k<nPtBins+1; k++)
	...
	hUSS_Y_Bkg[nPtBins-k]->SetBinError(bin,0);
      ...
      fBW_kstar[nPtBins-k]->SetParLimits(2, 0.047400, 0.04745);
      ...
      fBW_omega[nPtBins-k]->SetParLimits(2, 0.00849, 0.00855);
      ...
      fBW_rho[nPtBins-k]->SetParLimits(2, 0.1478, 0.1480);
      ...
      fFit[nPtBins-k]->SetParLimits(0, Min, Max);
      fFit[nPtBins-k]->SetParLimits(1, kstarMassMin, kstarMassMax);
      fFit[nPtBins-k]->SetParLimits(2, 0.047400, 0.04745);

      fFit[nPtBins-k]->SetParLimits(3, Min, Max);
      fFit[nPtBins-k]->SetParLimits(4, rhoMassMin, rhoMassMax);
      fFit[nPtBins-k]->SetParLimits(5, 0.1478, 0.1480);
      ...
      fFit[nPtBins-k]->SetParLimits(10, Min, Max);
      fFit[nPtBins-k]->SetParLimits(11, omegaMassMin, omegaMassMax);
      fFit[nPtBins-k]->SetParLimits(12, 0.00849, 0.0086);

      hUSS_Y_Fit[nPtBins-k]->GetXaxis()->SetRangeUser(0.75, 1.15);
      hUSS_Y_Fit[nPtBins-k]->Fit(fFit[nPtBins-k], "MSR0", "", Bglow, Bghigh);
