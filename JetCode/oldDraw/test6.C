...
void DrawVoigt(TString Kind, TString USS, TString LSS)
{
  ...
  for(int fpt=0; fpt<nPtBins; fpt++) //nPtBins+1 MUST DELETE +! When i wanna draw one histogram
	...
	hUSS_Y_Bkg[fpt]->SetBinError(bin,0);
      ...
      //=========================================================================
      fBW_kstar[fpt] = new TF1(Form("BW_kstar_fit_%i",fpt),"[0]*TMath::BreitWigner(x, [1], [2])", kstarMinRange, kstarMaxRange);
      fBW_kstar[fpt]->SetLineColor(2); //Red:2

      fBW_kstar[fpt]->SetParameter(0,1.0);
      fBW_kstar[fpt]->SetParameter(1,0.89166);
      fBW_kstar[fpt]->SetParameter(2,0.0474);

      //Information of omega(782)
      fBW_rho[fpt] = new TF1(Form("BW_rho_fit_%i",fpt),"[0]*TMath::BreitWigner(x, [1], [2])", rhoMinRange, rhoMaxRange);
      fBW_rho[fpt]->SetLineColor(2); //Red:2
      
      //fBW_rho[fpt]->SetParameter(3,1.0);
      fBW_rho[fpt]->SetParameter(1,0.78265);
      fBW_rho[fpt]->SetParameter(2,0.0849);
      
      //add
      hUSS_Y_Peak[fpt]->Fit(fBW_kstar[fpt], "0", "", kstarMinRange, kstarMaxRange);
      hUSS_Y_Peak[fpt]->Fit(fBW_kstar[fpt], "0", "", kstarMinRange, kstarMaxRange);
      hUSS_Y_Peak[fpt]->Fit(fBW_kstar[fpt], "0", "", kstarMinRange, kstarMaxRange);
      hUSS_Y_Peak[fpt]->Fit(fBW_kstar[fpt], "0", "", kstarMinRange, kstarMaxRange);
      
      hUSS_Y_Peak[fpt]->Fit(fBW_rho[fpt], "0", "", rhoMinRange, rhoMaxRange);
      hUSS_Y_Peak[fpt]->Fit(fBW_rho[fpt], "0", "", rhoMinRange, rhoMaxRange);
      hUSS_Y_Peak[fpt]->Fit(fBW_rho[fpt], "0", "", rhoMinRange, rhoMaxRange);
      hUSS_Y_Peak[fpt]->Fit(fBW_rho[fpt], "0", "", rhoMinRange, rhoMaxRange);
      ...
      // SIGNAL
      fFit[fpt]->SetParameter(0, fBW_kstar[fpt]->GetParameter(0));
      fFit[fpt]->SetParameter(1, fBW_kstar[fpt]->GetParameter(1));
      fFit[fpt]->SetParameter(2, fBW_kstar[fpt]->GetParameter(2));

      fFit[fpt]->SetParameter(3, fBW_rho[fpt]->GetParameter(0));
      fFit[fpt]->SetParameter(4, fBW_rho[fpt]->GetParameter(1));
      fFit[fpt]->SetParameter(5, fBW_rho[fpt]->GetParameter(2));
      ...
      fBW_kstar[fpt]->SetParameters(fFit[fpt]->GetParameters());
      fBW_rho[fpt]->SetParameters(fFit[fpt]->GetParameters());
