...
void DrawBW(TString Kind, TString USS, TString LSS)
{
  ...
  TF1* fBW_k700 [nPtBins];
  TF1* fBW_k800 [nPtBins];
  TF1* fBg [nPtBins];
  TF1* fFit [nPtBins];
  ...
  double kstarMass = 0.89555;
  double k700Mass = 0.845;
  double k800Mass = 0.676;
    
  double kstarMinRange = 0.75;
  double kstarMaxRange = 1.15;

  double k700MinRange = 0.75;
  double k700MaxRange = 1.15;

  double k800MinRange = 0.75;
  double k800MaxRange = 1.15;
  ...
  for (int k=1; k<nPtBins+1; k++)
      ...
      else
	{
      ...
      fBW_kstar[nPtBins-k]->FixParameter(2, 0.0473);
     
      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_kstar[nPtBins-k], "0", "", kstarMinRange, kstarMaxRange);

      //k700
      fBW_k700[nPtBins-k] = new TF1(Form("k700_bw_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2])", k700MinRange, k700MaxRange);

      fBW_k700[nPtBins-k]->SetParLimits(0, Min, Max);
      fBW_k700[nPtBins-k]->FixParameter(1, k700Mass);
      fBW_k700[nPtBins-k]->FixParameter(2, 0.468);

      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_k700[nPtBins-k], "0", "", k700MinRange, k700MaxRange);

      //k800
      fBW_k800[nPtBins-k] = new TF1(Form("k800_bw_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2])", k700MinRange, k700MaxRange);

      fBW_k800[nPtBins-k]->SetParLimits(0, Min, Max);
      fBW_k800[nPtBins-k]->FixParameter(1, k800Mass);
      fBW_k800[nPtBins-k]->FixParameter(2, 0.548);

      hUSS_Y_Fit[nPtBins-k]->Fit(fBW_k800[nPtBins-k], "0", "", k800MinRange, k800MaxRange);
      ...
      // ===============
      // fitting entire 
      fFit[nPtBins-k] = new TF1(Form("Fullfit_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2]) + pol3(6) + [3]*BreitWigner(x, [4], [5]) + [10]*BreitWigner(x, [11], [12])", Bglow, Bghigh);
 
      fFit[nPtBins-k]->SetParameter(0, fBW_kstar[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->FixParameter(1, fBW_kstar[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(2, fBW_kstar[nPtBins-k]->GetParameter(2));

      fFit[nPtBins-k]->SetParLimits(3, 0, fBW_k700[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->FixParameter(4, fBW_k700[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(5, fBW_k700[nPtBins-k]->GetParameter(2));
      ...
      fFit[nPtBins-k]->SetParLimits(10, 0, fBW_k800[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->FixParameter(11, fBW_k800[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(12, fBW_k800[nPtBins-k]->GetParameter(2));
      ...
      fBW_k700[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(3));
      fBW_k700[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(4));
      fBW_k700[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(5));

      fBW_k800[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(10));
      fBW_k800[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(11));
      fBW_k800[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(12));
      ...
      fBW_k700[nPtBins-k]->SetLineColor(7); //mint
      fBW_k700[nPtBins-k]->Draw("SAME");

      fBW_k800[nPtBins-k]->SetLineColor(8);
      fBW_k800[nPtBins-k]->Draw("SAME");
