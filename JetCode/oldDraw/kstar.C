  ...
  for (int k=1; k<nPtBins+1; k++)
    {
      ...
      fFit[nPtBins-k] = new TF1(Form("Fullfit_%i", nPtBins-k), "[0]*BreitWigner(x, [1], [2]) + pol3(3)", Bglow, Bghigh);
      ...
      fFit[nPtBins-k]->SetParameter(3, fBg[nPtBins-k]->GetParameter(0));
      fFit[nPtBins-k]->SetParameter(4, fBg[nPtBins-k]->GetParameter(1));
      fFit[nPtBins-k]->SetParameter(5, fBg[nPtBins-k]->GetParameter(2));
      fFit[nPtBins-k]->SetParameter(6, fBg[nPtBins-k]->GetParameter(3));
      ...
      fBg[nPtBins-k]->FixParameter(0, fFit[nPtBins-k]->GetParameter(3));
      fBg[nPtBins-k]->FixParameter(1, fFit[nPtBins-k]->GetParameter(4));
      fBg[nPtBins-k]->FixParameter(2, fFit[nPtBins-k]->GetParameter(5));
      fBg[nPtBins-k]->FixParameter(3, fFit[nPtBins-k]->GetParameter(6));
