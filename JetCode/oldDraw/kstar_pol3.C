  ...
  for (int k=1; k<nPtBins+1; k++)
    {
      ...
      fBg[nPtBins-k]->SetParameter(0, fFit[nPtBins-k]->GetParameter(3));
      fBg[nPtBins-k]->SetParameter(1, fFit[nPtBins-k]->GetParameter(4));
      fBg[nPtBins-k]->SetParameter(2, fFit[nPtBins-k]->GetParameter(5));
      fBg[nPtBins-k]->SetParameter(3, fFit[nPtBins-k]->GetParameter(6));
