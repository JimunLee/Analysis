...
void DrawBW(TString Kind, TString USS, TString LSS)
{
  ...
  if (Kind == "Inclusive"){
	...
	// Function
	// ==============
	fBg[k] = new TF1(Form("kstar_Bg_%i",k), "exp([1]*x + [2]*x*x + [3]*x*x*x)", ExtraMinRange, BgMaxRange);
	...
	fFit[k] = new TF1(Form("Fullfit_%i", k), "exp([1]*x + [2]*x*x + [3]*x*x*x) + pol4(4) + [9]*BreitWignerRelativistic(x, [10], [11])", ExtraMinRange, BgMaxRange);
	
	//======
	//Tmp1
	//======
	fBgTmp[k] = new TF1(Form("kstar_ExtraBgTmp_%i",k), "exp([1]*x + [2]*x*x + [3]*x*x*x)+pol4(4)", ExtraMinRange, BgMaxRange);
	...
	fFit_Tmp[k] = new TF1(Form("FullfitTmp_%i", k), "exp([1]*x + [2]*x*x + [3]*x*x*x) + pol4(4) + [9]*BreitWignerRelativistic(x, [10], [11])", ExtraMinRange, BgMaxRange);

	/* for (int bin = hUSS_Y_Bg[k]->FindBin(1.16); bin <= hUSS_Y_Bg[k]->FindBin(1.25); bin++) */
	/*   hUSS_Y_Bg[k]->SetBinError(bin, 0); */
	fBg[k] = new TF1(Form("kstar_DoubleBg_%i",k), "exp([1]*x + [2]*x*x + [3]*x*x*x) + pol4(4)", ExtraMinRange, BgMaxRange);
	if(k==0){
	  ...
	  for (int bin = hUSS_Y_Bg[k]->FindBin(0.83); bin <= hUSS_Y_Bg[k]->FindBin(0.94); bin++)
	    hUSS_Y_Bg[k]->SetBinError(bin, 0);
	  for (int bin = hUSS_Y_kstarSig[k]->FindBin(0.775); bin <= hUSS_Y_kstarSig[k]->FindBin(0.825); bin++)
	    hUSS_Y_kstarSig[k]->SetBinError(bin, 0);
	  /* for (int bin = hUSS_Y_Bg[k]->FindBin(0.83); bin <= hUSS_Y_Bg[k]->FindBin(0.97); bin++) */
	  /*   hUSS_Y_Bg[k]->SetBinError(bin, 0); */
	  // fFit[k]->SetParameter(0, fBg[k]->GetParameter(0));
	  fFit[k]->SetParameter(1, fBg[k]->GetParameter(1));
	  fFit[k]->SetParameter(2, fBg[k]->GetParameter(2));
	...
	/* else if(k==5){ */
	/*   for (int bin = hUSS_Y_Bg[k]->FindBin(0.8); bin <= hUSS_Y_Bg[k]->FindBin(1.03); bin++) */
	/*     hUSS_Y_Bg[k]->SetBinError(bin, 0); */
	/*   fFit[k]->SetParameter(0, fBg[k]->GetParameter(0)); */
	/*   fFit[k]->SetParameter(1, fBg[k]->GetParameter(1)); */
	/*   fFit[k]->SetParameter(2, fBg[k]->GetParameter(2)); */
	...
	// =================================================================================
	fBg_POST[k] = new TF1(Form("kstar_ExtraBg_POST_%i",k), "exp([1]*x + [2]*x*x + [3]*x*x*x) + pol4(4)", ExtraMinRange, BgMaxRange);
	...
	//Tmp
	//=============================================================
	fBgTmp_POST[k] = new TF1(Form("kstar_ExtraBgTMP_POST_%i",k), "exp([1]*x + [2]*x*x + [3]*x*x*x) + pol4(4)", ExtraMinRange, BgMaxRange);
  ...
  // Jet
	...
	//Origin
	//======
	fBg[k] = new TF1(Form("kstar_ExtraBg_%i",k), "exp([1]*x + [2]*x*x + [3]*x*x*x)", ExtraMinRange, BgMaxRange);
