  ...
  for (int k=1; k<nPtBins+1; k++)
    {
      ...
      // ===============
      // fitting entire 
      fFit[nPtBins-k] = new TF1(Form("Fullfit_%i", nPtBins-k), "[0]*BreitWignerRelativistic(x, [1], [2]) + [3]*BreitWignerRelativistic(x, [4], [5]) + [6]*BreitWignerRelativistic(x, [7], [8]) + pol3(9)", Bglow, Bghigh);
      ...
      fBW_kstar[nPtBins-k]->FixParameter(0, fFit[nPtBins-k]->GetParameter(0));
      fBW_kstar[nPtBins-k]->FixParameter(1, fFit[nPtBins-k]->GetParameter(1));
      fBW_kstar[nPtBins-k]->FixParameter(2, fFit[nPtBins-k]->GetParameter(2));

      fBW_omega[nPtBins-k]->FixParameter(0, fFit[nPtBins-k]->GetParameter(3));
      fBW_omega[nPtBins-k]->FixParameter(1, fFit[nPtBins-k]->GetParameter(4));
      fBW_omega[nPtBins-k]->FixParameter(2, fFit[nPtBins-k]->GetParameter(5));

      fBW_rho[nPtBins-k]->FixParameter(0, fFit[nPtBins-k]->GetParameter(6));
      fBW_rho[nPtBins-k]->FixParameter(1, fFit[nPtBins-k]->GetParameter(7));
      fBW_rho[nPtBins-k]->FixParameter(2, fFit[nPtBins-k]->GetParameter(8));

      fBg[nPtBins-k]->FixParameter(0, fFit[nPtBins-k]->GetParameter(9));
      fBg[nPtBins-k]->FixParameter(1, fFit[nPtBins-k]->GetParameter(10));
      fBg[nPtBins-k]->FixParameter(2, fFit[nPtBins-k]->GetParameter(11));
      fBg[nPtBins-k]->FixParameter(3, fFit[nPtBins-k]->GetParameter(12));
