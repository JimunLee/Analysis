...
void DrawBW()
{
  ...
  TString mainfile = "../kstar-in-jets/Results_rootfile/JetChHighPt100_merged.root";
  TFile* data = TFile::Open(mainfile);
  if(!data)   return;

  TString USSKPiName("kstar-in-o-o/hUSS_KPi_INSIDE;1");
  TString USSPiKName("kstar-in-o-o/hUSS_PiK_INSIDE;1");
  TString LSSKPiName("kstar-in-o-o/hLSS_KPi_INSIDE;1");
  TString LSSPiKName("kstar-in-o-o/hLSS_PiK_INSIDE;1");
  ...
  for (int i=0; i<nPtBins; i++)
    {
      ...
      TLatex* txtInfoBB = DrawTLatex(0.173, 0.873, "Jets MB", 0.04, 62, 1);
