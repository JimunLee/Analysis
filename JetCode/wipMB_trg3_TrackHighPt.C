...
void DrawBW()
{
  ...
  TString localpath = "Data/Inclusive/TrackHighPt/";
  //===================
  // Data file inputs 
  //===================
  ...
  TString USSKPiName("kstar-in-o-o_id45657/hUSS_KPi;1");
  TString USSPiKName("kstar-in-o-o_id45657/hUSS_PiK;1");
  TString LSSKPiName("kstar-in-o-o_id45657/hLSS_KPi;1");
  TString LSSPiKName("kstar-in-o-o_id45657/hLSS_PiK;1");
  TString CentName("kstar-in-o-o_id45657/nEvents;1");
  //============================================================================
  ...
  double yMin = 1e-4;
  double yMax = 1e-2;
  hYield->SetMinimum(yMin);
  hYield->SetMaximum(yMax);

  nEvents = hCent->GetBinContent(3);    
  hYield->Scale(1/nEvents);

  TFile* fout = TFile::Open("../kstar-in-jets/Results_draw/UncorrectedpTspectra_trg3_TrackHighPt.root", "RECREATE");
