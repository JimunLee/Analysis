...
void ShiftedKstar()
{
  ...
  TString main_EPOS = "/Users/jimun/Analysis/kstar-in-jets/Results_rootfile/myepos.root";
  ...
  HistoAxisTitles(h_origin_6_8_PY, "K*0 pT [GeV/#it{c}]", "Counts", 0.05, 62, 1.0, 0.05, 62, 1.0);
  ...
  TLegend* L1 = new TLegend(0.51, 0.58, 0.79, 0.81);
  L1->SetBorderSize(0);
  L1->SetTextSize(0.05);
  L1->AddEntry(h_origin_6_8_PY, "Original (6 < Jet p_{T} < 8 GeV/c)", "l");
  L1->AddEntry(h_recovered_8_12_PY, "Recovered (6-8 #rightarrow 8-12)", "l");
  L1->AddEntry(h_origin_8_12_PY, "Original (8 < Jet p_{T} < 12 GeV/c)", "l");
  L1->Draw("SAME");

  TLatex* txtInfoA = DrawTLatex(0.525, 0.858, "PYTHIA", 0.06, 62, 1);
  ...
  HistoAxisTitles(h_Ratio_recOver8_12_PY, "K*0 pT [GeV/#it{c}]", "", 0.12, 62, 0.8, 0.1, 62, 1.0);
  ...
  L2->SetBorderSize(0);
  L2->SetTextSize(0.1);
  L2->AddEntry(h_Ratio_recOver8_12_PY, "Recovered/Origin[8,12]", "l");
  L2->AddEntry(h_Ratio_recOver6_8_PY, "Recovered/Origin[6,8]", "l");
  L2->Draw();
  ...
  L1_HW->AddEntry(h_origin_6_8_HW, "Original (6 < Jet p_{T} < 8 GeV/c)", "l");
  L1_HW->AddEntry(h_recovered_8_12_HW, "Recovered (6-8 #rightarrow 8-12)", "l");
  L1_HW->AddEntry(h_origin_8_12_HW, "Original (8 < Jet p_{T} < 12 GeV/c)", "l");
  L1_HW->Draw();
  ...
  L2_HW->AddEntry(h_Ratio_recOver8_12_HW, "Recovered/Origin[8,12]", "l");
  L2_HW->AddEntry(h_Ratio_recOver6_8_HW, "Recovered/Origin[6,8]", "l");
  L2_HW->Draw();
  ...
  //myepos
  h_origin_6_8_EPOS->Rebin(4);
  h_recovered_8_12_EPOS->Rebin(4);
  h_origin_8_12_EPOS->Rebin(4);
  ...
  L1_EPOS->AddEntry(h_origin_6_8_EPOS, "Original (6 < Jet p_{T} < 8 GeV/c)", "l");
  L1_EPOS->AddEntry(h_recovered_8_12_EPOS, "Recovered (6-8 #rightarrow 8-12)", "l");
  L1_EPOS->AddEntry(h_origin_8_12_EPOS, "Original (8 < Jet p_{T} < 12 GeV/c)", "l");
  L1_EPOS->Draw("SAME");
  ...
  L2_EPOS->AddEntry(h_Ratio_recOver8_12_EPOS, "Recovered/Origin[8,12]", "l");
  L2_EPOS->AddEntry(h_Ratio_recOver6_8_EPOS, "Recovered/Origin[6,8]", "l");
  L2_EPOS->Draw();
