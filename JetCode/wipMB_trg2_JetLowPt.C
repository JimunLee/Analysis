...
void DrawBW()
{
  ...
  TString localpath = "Data/Inclusive/JetLowPt/";
  //===================
  // Data file inputs 
  //===================
  ...
  TString USSKPiName("kstar-in-o-o_id45656/hUSS_KPi;1");
  TString USSPiKName("kstar-in-o-o_id45656/hUSS_PiK;1");
  TString LSSKPiName("kstar-in-o-o_id45656/hLSS_KPi;1");
  TString LSSPiKName("kstar-in-o-o_id45656/hLSS_PiK;1");
  TString CentName("kstar-in-o-o_id45656/nEvents;1");
  //============================================================================
  ...
  TFile* fout = TFile::Open("../kstar-in-jets/Results_draw/UncorrectedpTspectra_trg2_JetLowPt.root", "RECREATE");
  ...
  TLatex* txtInfoBBB = DrawTLatex(0.59, 0.789, "JetChLowPt, #sqrt{s} = 13.6 TeV", 0.05, 42, 1);
