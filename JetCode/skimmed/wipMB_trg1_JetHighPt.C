...
void DrawBW()
{
  ...
  TString localpath = "Data/Inclusive/JetHighPt/";
  //===================
  // Data file inputs 
  //===================
  ...
  TString USSKPiName("kstar-in-o-o_id45527/hUSS_KPi;1");
  TString USSPiKName("kstar-in-o-o_id45527/hUSS_PiK;1");
  TString LSSKPiName("kstar-in-o-o_id45527/hLSS_KPi;1");
  TString LSSPiKName("kstar-in-o-o_id45527/hLSS_PiK;1");
  TString CentName("kstar-in-o-o_id45527/nEvents;1");
  //============================================================================
  ...
  TFile* fout = TFile::Open("../kstar-in-jets/Results_draw/UncorrectedpTspectra_trg1_JetHighPt.root", "RECREATE");
  ...
  numbin->SetLogy();
  numbin->SaveAs("../kstar-in-jets/Plot/kstarInjets/"+localpath+"h_Yield_trg1_JetHighPt.png", "RECREATE");
}//DrawBW
