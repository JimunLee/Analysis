...
void DrawBW()
{
  ...
  TString localpath = "Data/Inclusive/TrackLowPt/";
  //===================
  // Data file inputs 
  //===================
  ...
  TString USSKPiName("kstar-in-o-o_id45658/hUSS_KPi;1");
  TString USSPiKName("kstar-in-o-o_id45658/hUSS_PiK;1");
  TString LSSKPiName("kstar-in-o-o_id45658/hLSS_KPi;1");
  TString LSSPiKName("kstar-in-o-o_id45658/hLSS_PiK;1");
  TString CentName("kstar-in-o-o_id45658/nEvents;1");
  //============================================================================
  ...
  for (Int_t i=0; i<nPtBins; i++)
	...
	if (bin < binLow || bin > binHigh) {
      ...
      TLatex* txtInfoD = DrawTLatex(0.522, 0.216, "Track Low pT", 0.04, 42, 1);
  ...
  TFile* fout = TFile::Open("../kstar-in-jets/Results_draw/UncorrectedpTspectra_trg4_TrackLowPt.root", "RECREATE");
