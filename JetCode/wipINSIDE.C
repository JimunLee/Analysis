...
void DrawBW()
{
  ...
  TString USSKPiName("kstar-in-o-o_id47050/hUSS_KPi_INSIDE;1");
  TString USSPiKName("kstar-in-o-o_id47050/hUSS_PiK_INSIDE;1");
  TString LSSKPiName("kstar-in-o-o_id47050/hLSS_KPi_INSIDE;1");
  TString LSSPiKName("kstar-in-o-o_id47050/hLSS_PiK_INSIDE;1");
  TString CentName("kstar-in-o-o_id47050/nEvents;1");
  //============================================================================
  ...
  for (Int_t i=0; i<nPtBins; i++)
	...
	if (bin < binLow || bin > binHigh) {
      ...
      TLatex* txtInfoA = DrawTLatex(0.521, 0.318, "Inside Jets", 0.04, 62, 1);
  ...
  for (int i=0; i<nPtBins; i++)
    {
      ...
      TLatex* txtInfoBB = DrawTLatex(0.173, 0.873, "Inside Jets", 0.04, 62, 1);
