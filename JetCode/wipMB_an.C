...
void DrawBW()
{
  ...
  // Data file inputs 
  TString mainfile = "../kstar-in-jets/Results_rootfile/MB_an_skimmed_merged.root";
  ...
  TFile* fout = TFile::Open("../kstar-in-jets/Results_draw/MBuncorrectedpTspectra.root", "RECREATE");
