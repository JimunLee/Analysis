...
struct kstarInOO {
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    if (cfgJetdRHistos) {
      ...
      histos.add("JetMigration", "bin to bin migration", {HistType::kTH2F, {{100, 0.0, 50.0, "True jet pT (GeV/c)"}, {100, 0., 50., "Missed jet pT (GeV/c)"}}});
    }
  ...
  void processJetQA(o2::aod::JetMcCollision const& collision, soa::Filtered<aod::ChargedMCParticleLevelJets> const& mcpjets, aod::JetParticles const& mcParticles, aod::McParticles const&)
  {
	...
	if (cfgJetdRHistos){
	  ...
	  if ((bestJetpT - missing_pt) > 6.0)
	    histos.fill(HIST("JetMigration"), bestJetpT, bestJetpT - missing_pt);
